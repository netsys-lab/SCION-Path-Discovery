...
- [ ] Release 1.0 version of the [library](https://github.com/netsys-lab/scion-path-discovery/releases/tag/v0.1.1) and [BitTorrent over SCION](https://github.com/netsys-lab/bittorrent-over-scion/releases/tag/v0.1.0)
